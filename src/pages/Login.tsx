    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-neutral-900 text-gray-900 dark:text-white p-4 transition-colors duration-300">
            ...
            <div className="w-full max-w-md bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-xl border border-gray-200 dark:border-neutral-700 transition-colors duration-300">
                <h1 className="text-3xl font-bold mb-2 text-center text-blue-600 dark:text-blue-400">Welcome Back! 👋</h1>
                <p className="text-gray-500 dark:text-gray-400 text-center mb-8">Login to continue your learning journey.</p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <div>
                        ...
                        <input
                            type="email"
                            required
                            className="w-full bg-gray-50 dark:bg-neutral-900 border border-gray-300 dark:border-neutral-600 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 outline-none transition-colors"
                            value={email}
                    ...
                    {/* Role Selection */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">Login Sebagai</label>
                        <div className="flex gap-4">
                            <label className={`flex-1 flex items-center justify-center p-3 rounded-lg border cursor-pointer transition-all ${role === 'student' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'border-gray-200 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800'}`}>
                                <input
                                    type="radio"
                                    name="role"
                                    value="student"
                            ...
                            <label className={`flex-1 flex items-center justify-center p-3 rounded-lg border cursor-pointer transition-all ${role === 'teacher' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'border-gray-200 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-800'}`}>
                                <input
                                    type="radio"
                                    name="role"
                                    value="teacher"
                    ...
                    <button type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 rounded-lg transition-colors mt-2">
                        Login
                    </button>
                </form>
